...
insert into Users values ('Smileyman5', 'password', '03/16/1996', 'Alex', 'Kouthoofd', 'male');
insert into Users values ('JonMan', 'password', '02/18/1995', 'Jon', 'Baker', 'male');
insert into Users values ('Dummy', 'password', '12/12/1990', 'Dum', 'Me', 'male');
insert into Users values ('JesGirl', 'password', '06/08/1993', 'Jess', 'Smith', 'female');
insert into Users values ('DaisyDuke', 'password', '11/21/1995', 'Daisy', 'Duke', 'female');
